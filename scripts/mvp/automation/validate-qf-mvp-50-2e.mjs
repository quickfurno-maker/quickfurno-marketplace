...
record("G08 the local migration set is exactly 99 and the 50.2 wedge repair is still present in order",
  (() => {
...
record("G09 the 50.2D validator was re-pinned, not loosened",
  /I05 the local migration count is exactly 99/.test(d2Source) &&
  /exactly twelve migrations are newer than the anchor/.test(d2Source) &&
