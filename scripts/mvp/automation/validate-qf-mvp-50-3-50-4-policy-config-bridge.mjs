...
record("V07a the final twenty-four versions are in exact chronological order",
  same(migrationFiles.slice(-24),
...
record("V07 the local migration set is exactly 116",
