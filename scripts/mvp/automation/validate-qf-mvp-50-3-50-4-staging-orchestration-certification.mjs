...
// renamed, deleted or reordered. Still exact equality.
  ...
  check("local migration count remains exactly 107", state.migrationFiles.length === 107);
  ...
  check("the governed pending set holds exactly the three pinned source-only authorities, one is staging-applied, and the five governed authorities are reconciled as APPLIED",
