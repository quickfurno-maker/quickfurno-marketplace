...
/*
  ...
  client enquiries are free, vendor review and approval exist and misuse controls
  remain. No new financial, refund or payment obligation is created.

  Section 2 previously used verification wording that read as a hard ceiling. The
  consent the client accepts allows QuickFurno to manually connect additional
  eligible vendors where the first vendors are
        ...
        <div className="qf-legal-shell">
          ...
          <div className="qf-legal-body">
            <div className="qf-legal-note">
              ...
              <ul>
                <li>QuickFurno matches homeowners with eligible vendors; it does not do the work.</li>
            ...
            <section className="qf-legal-section">
              ...
              <p>
                QuickFurno is a marketplace that connects homeowners with eligible home-service
            ...
            <section className="qf-legal-section">
              ...
              <p>
                Client enquiries are free. One enquiry is shared with up to 3 eligible vendors
                ...
                manually connect you with additional eligible vendors. Vendors contact you directly
            ...
            <section className="qf-legal-section">
              ...
              <p>
                ...
                their work and their conduct with clients. QuickFurno reviews vendor submissions before
                approved profiles can go live, but is not a party to the contract between a client and a vendor.
              </p>
            </section>
