...
// deleted or reordered. Still exact equality.
  ...
  check('J03 G1 is re-pinned to 119 by exact equality, never loosened to >=',
  ...
  check('J06 the manifest post-anchor count is 32: ten applied, five reconciled, seven staging-applied, ten pending',
