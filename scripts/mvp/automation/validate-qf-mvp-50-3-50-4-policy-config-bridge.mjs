...
record("V07a the final twenty-one versions are in exact chronological order",
  same(migrationFiles.slice(-21),
...
record("V07 the local migration set is exactly 113",
...
record("G06 pending holds exactly seven pinned source-only authorities, four are staging-applied, and the five governed authorities are reconciled as APPLIED",
...
record("G08 the anchor post-anchor count agrees at 26",
  manifest.appliedAnchor?.postAnchorMigrationCount === POST_ANCHOR_COUNT);
record("G09 G1 is pinned to 113 / 10 applied / 5 reconciled / 4 staging-applied / 7 pending, not loosened",
  /const MIGRATION_COUNT = 113;/.test(g1Source) &&
