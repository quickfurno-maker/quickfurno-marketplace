...
import { VendorOverview } from "@/components/vendor-dashboard-v2/VendorOverview";
import type { VendorOverviewLead } from "@/components/vendor-dashboard-v2/vendorOverviewModel";
...
export default async function VendorDashboardPage() {
  ...
  return <VendorOverview vendor={vendor} stats={stats} leads={leads} />;
}
