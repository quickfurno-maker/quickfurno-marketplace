...
WAVE 1 client_lead_status_update / client_matching_update / lead_assignment_alert APPROVED AS
  UTILITY (QF-MVP-40.10F) — APPROVED_UNMAPPED, HELD
WAVE 1 consent_stop_acknowledgement / consent_start_acknowledgement / vendor_onboarding_reminder
  APPROVED AS UTILITY (QF-MVP-40.10G) — APPROVED_UNMAPPED, HELD
APPROVAL GRANTS PROVIDER CONTRACT ONLY: NO CONSENT, MAPPING, ACTIVATION OR SEND
CONSENT ACK APPROVAL DOES NOT ADD IT TO THE ORDINARY OUTBOUND REGISTRY
WAVE 1 OWNER REVIEW PARTIALLY_REVIEWED — 7 CLOSED, 7 PENDING AND NOT AUTHORIZED
FURTHER TEMPLATE SUBMISSION PAUSED (QF-MVP-40.10G)
