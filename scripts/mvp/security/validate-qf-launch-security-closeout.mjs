...
record("A04 later forward migrations are allowed while the closeout migration remains pinned",
  readdirSync(path.join(ROOT, "supabase/migrations")).filter((f) => f.endsWith(".sql")).length === 114 &&
