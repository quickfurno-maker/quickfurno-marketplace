...
record("V07a the final nineteen versions are in exact chronological order",
  same(migrationFiles.slice(-19),
...
record("V07 the local migration set is exactly 111",
...
record("G06 pending holds exactly seven pinned source-only authorities, two are staging-applied, and the five governed authorities are reconciled as APPLIED",
...
record("G08 the anchor post-anchor count agrees at 24",
