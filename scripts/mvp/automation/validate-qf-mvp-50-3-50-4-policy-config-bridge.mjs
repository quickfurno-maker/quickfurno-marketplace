...
record("V07a the final twenty-three versions are in exact chronological order",
  same(migrationFiles.slice(-23),
...
record("V07 the local migration set is exactly 115",
...
record("G06 pending holds exactly eight pinned source-only authorities, five are staging-applied, and the five governed authorities are reconciled as APPLIED",
...
record("G08 the anchor post-anchor count agrees at 28",
  manifest.appliedAnchor?.postAnchorMigrationCount === POST_ANCHOR_COUNT);
record("G09 G1 is pinned to 115 / 10 applied / 5 reconciled / 5 staging-applied / 8 pending, not loosened",
  /const MIGRATION_COUNT = 115;/.test(g1Source) &&
