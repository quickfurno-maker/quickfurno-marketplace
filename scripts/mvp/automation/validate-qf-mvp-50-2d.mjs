...
record("I03 exactly fourteen migrations are newer than the anchor",
  migrationFiles.filter((f) => f.slice(0, 14) > "20260803000000").length === 14);
...
// canonical marketing-consent writer RPC (20260814000000). No existing migration was
// changed, renamed, deleted or reordered. Still exact equality.
record("I05 the local migration count is exactly 101", migrationFiles.length === 101);
...
record("G03 exactly ten APPLIED and four PENDING post-anchor migrations are declared",
