...
record("G02 pending holds exactly seven pinned source-only authorities, two are staging-applied, five are reconciled, and 50.5 is the newest applied record",
...
record("G06 the local migration set is exactly 111",
