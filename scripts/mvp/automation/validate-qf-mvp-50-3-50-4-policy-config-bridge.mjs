...
record("G06 pending holds exactly nine pinned source-only authorities, eight are staging-applied, and the five governed authorities are reconciled as APPLIED",
  ...
  manifest.pendingPostAnchorMigrations[8].version === "20260924183000" &&
  ...
  manifest.stagingAppliedPostAnchorMigrations[6].version === "20260919010000" &&
  manifest.stagingAppliedPostAnchorMigrations[6].operationalStatus === "APPLIED_TO_STAGING" &&
  manifest.stagingAppliedPostAnchorMigrations[6].appliedToStaging === true &&
...
record("G09 G1 is pinned to 119 / 10 applied / 5 reconciled / 8 staging-applied / 9 pending, not loosened",
