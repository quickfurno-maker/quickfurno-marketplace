...
export const metadata = { title: "Client Matching - QuickFurno" };
...
export default async function VendorLeadsPage(props: VendorLeadsPageProps) {
  ...
  const feedback = readLeadFeedback(searchParams?.match ?? searchParams?.lead);

  return (
    <div className="qf-vendor-v2-leads">
      <header className="qf-vendor-v2-leads-head">
        <div>
          <h1 className="qf-vendor-v2-leads-title">Client Matching</h1>
          <p className="qf-vendor-v2-leads-sub">View and manage client enquiries matched to your business.</p>
        </div>
      ...
      {!leadsResult.ok ? (
        <div className="qf-vendor-v2-leads-alert" data-tone="error" role="status">
          ...
          <p className="qf-vendor-v2-leads-alert-text">
            Client matches are not available right now. Please refresh in a moment.
          </p>
        </div>
      ) : null}
      ...
      {rows.length === 0 ? (
        <div className="qf-vendor-v2-panel">
          <div className="qf-vendor-v2-empty">
            ...
            <p className="qf-vendor-v2-empty-title">No client matches yet</p>
