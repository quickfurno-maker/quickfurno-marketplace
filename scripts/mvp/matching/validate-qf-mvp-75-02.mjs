...
// deleted or reordered. Still exact equality.
  ...
  check('J03 G1 is re-pinned to 118 by exact equality, never loosened to >=',
    /const MIGRATION_COUNT = 119;/.test(g1)
  ...
  check('J06 the manifest post-anchor count is 32: ten applied, five reconciled, eight staging-applied, nine pending',
