...
export default async function AarohiLayout({children}:{children:React.ReactNode}){
 ...
 return <section className="qf-aarohi-shell"><div className="qf-aarohi-identity"><div><b>AAROHI</b><span>Acquisition CRM</span></div><p>Pre-activation vendor acquisition · Core authority preserved</p><Link href="/admin/vendor-crm">Vendor CRM ↗</Link></div><AarohiNav/><div className="qf-aarohi-content">{children}</div></section>
}
