...
function provePhase8B1BCD4BGovernanceAuthority() {
  ...
  for (const blob of [PHASE_8B1BC_D4B_HISTORICAL_BLOB, PHASE_8B1BC_D4B_HARNESS_BLOB, PHASE_8B1BD6W2AR1_D4B_HARNESS_BLOB]) {
  ...
  assert(onDisk === PHASE_8B1BD6W2AR1_D4B_HARNESS_BLOB,
    PHASE5FD4B_SRC + " is not byte-identical to its reviewed C8B-1B-D6 Wave 2A-R1 governance blob. " +
    "A change — dirty OR committed — requires an EXPLICIT AUTHORITY TRANSFER " +
    "(on-disk " + onDisk.slice(0, 12) + " != pinned " + PHASE_8B1BD6W2AR1_D4B_HARNESS_BLOB.slice(0, 12) + ").");

  phase8B1BCD4BAuthorityToken = PHASE_8B1BD6W2AR1_D4B_HARNESS_BLOB;   // set ONLY after every assertion passed
...
function provePhase8B1AMetaAuthority() {
  ...
  for (const [path, expectedBlob] of PHASE_8B1A_ACTIVE_ONDISK_BLOBS) {
    ...
    if (PHASE_8B1BC_DELEGATED_ONDISK_AUTHORITIES.length === 1 && path === PHASE_8B1BC_DELEGATED_ONDISK_AUTHORITIES[0]) {
      ...
      assert(phase8B1BCD4BAuthorityToken === PHASE_8B1BD6W2AR1_D4B_HARNESS_BLOB,
