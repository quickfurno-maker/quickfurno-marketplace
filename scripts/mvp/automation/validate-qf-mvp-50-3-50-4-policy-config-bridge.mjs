...
record("V07a the final fifteen versions are in exact chronological order",
  same(migrationFiles.slice(-15),
...
record("V07 the local migration set is exactly 107",
...
record("G06 pending holds exactly three pinned source-only authorities, one is staging-applied, and the five governed authorities are reconciled as APPLIED",
...
record("G08 the anchor post-anchor count agrees at 20",
  manifest.appliedAnchor?.postAnchorMigrationCount === POST_ANCHOR_COUNT);
record("G09 G1 was re-pinned to 107 / 10 applied / 5 reconciled / 1 staging-applied / 4 pending, not loosened",
